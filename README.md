...
## Milestone 3
### Feedback
* Slideshow pictures stretched - Crop/resize them in a photo editor before putting them onto your site.  If you can get wider photos and can make it work on mobile, my suggestions is a 16:9 ratio at full screen width.
* Embedded video is unavailable
* Contact form directs me to https://www.rainbowsnow.best/php/mailer.php, which errors out with a 404.  Even if Sendgrid is not configured properly, I should get a message that says that the form worked.
* On mobile, main image and video aren't resizing correctly.  Title also gets cut off at very small sizes.
* Nice use of animation for the Locations and Upcoming events sections.
* The color scheme is intense, but the summery pastel colors work well for a shaved ice shop.
* Good work on git commits.  All the ones that I checked are bite-sized, and have descriptive messages associated with them.
* Indentation on your index.php file is all over the map.  Don't forget to do ctrl-shift-f to fix your formatting!

Overall, this website has some nice touches, but has some fundamental functionality issues, and could use a bit of design polish to take it to the next level.  The color scheme is a good match for the business, but I might break it up a bit with some other sections so that it's not quite so overwhelming.  The animations are good, but picture stretching and contact form issues keep this site from feeling truly professional.

Your code, by and large, is clean and well written, with the exception of some indentation issues.   Your git history is good, and you have patterns in here that make sense and are consistent.  Well done.
#### Grade Tier II
